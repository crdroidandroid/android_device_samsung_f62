...
git clone https://github.com/linux4-bringup-priv/android_kernel_samsung_exynos9820 kernel/samsung/exynos9820
...
git clone https://github.com/ProjectElixir-Devices/android_device_samsung_f62 device/samsung/f62

echo 'Cloning Vendor Trees [4/7]'
# Vendor blobs for f62
rm -rf vendor/samsung/f62
git clone https://github.com/linux4-bringup-priv/android_vendor_samsung_f62 vendor/samsung/f62
